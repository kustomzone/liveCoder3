...
function initEvents(inputState) {
  ...
  inputState = inputState || {
	...
	set mouseHandler(val) {
	  // error..
	  console.log("[inputState] mouseHandler changed: %s -> %s", printmouseHandler(this._mouseHandler), printmouseHandler(val));
...
function loadConsoleScript(thenDo) {
  lively.lang.arr.mapAsyncSeries([
	["app/jquery/jquery-1.9.1.js", function() { return !!window.jQuery; }],
	["app/lively/html-console.js", function() { return !!document.querySelector("#log"); }]
